...
def get_valid_date(prompt):
    ...
    # Функция get_titles запрашивает ровно 3 заголовка у пользователя.
def get_titles():
    titles = [] # Создаем пустой список для хранения заголовков

    # Используем цикл для ввода заголовков
    for i in range(3): # Фиксируем 3 итерации
        title = input(f"Введите заголовок {i + 1}: ") # Запрашиваем заголовок
